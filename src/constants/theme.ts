...
export const DarkColors: ThemeColors = {
  surface: '#141312',
  surfaceDim: '#0f0e0d',
  surfaceBright: '#201e1d',
  surfaceContainerLowest: '#0a0909',
  surfaceContainerLow: '#1a1918',
  surfaceContainer: '#201e1c',
  surfaceContainerHigh: '#272523',
  surfaceContainerHighest: '#302d2a',
  surfaceVariant: '#2b2826',

  onSurface: '#f6f4f2',
  onSurfaceVariant: '#bfb3a7',
  inverseSurface: '#fcf9f8',
  inverseOnSurface: '#1c1b1b',

  outline: '#8a7e72',
  outlineVariant: '#38332d',
  ...
  tertiaryFixed: '#24211f',
  tertiaryFixedDim: '#1c1a18',
  onTertiaryFixed: '#f6f4f2',
  onTertiaryFixedVariant: '#d8cdbf',
